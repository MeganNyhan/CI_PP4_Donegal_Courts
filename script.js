...
(function($){
    $.fn.lightWeightPopup = function(options) {
        ...
        $(this).on("click",function(){
            ...
            $("body").append('<div class="lwp-overlay" '+setOL+'></div><div class="lwp" tabindex="-1" role="dialog" style="'+sw+' '+sh+' '+smw+' '+smh+' '+spt+'"><div id="lwp" style="'+setIFH+'"><div id="lwpHead"><div class="title">'+settings.title+'</div><div class="close" onclick="closeDilog(\''+dset.content+'\')"><span>&times;</span></div></div><div id="lwpBody" role="document" '+setMF+'><div class="loading"><img src="image/loader.gif"><p class="text">Please Wait..!</p></div></div></div></div>');
